...
class _KomplainMitraState extends State<KomplainMitra>{
  ...
  Future<String> getKomendata() async {
    var response = await http.post(
        ...
        Uri.encodeFull(
            'http://siplah.mascitra.co.id/siplah/api/mitra/komplain/pesan'),
        headers: {
  ...
  Future<http.Response> daftar_api() async {
    ...
    var url = 'http://siplah.mascitra.co.id/siplah/api/mitra/komplain/tambah';
 ...
 void _showAlertupload(BuildContext context) {
  ...
  Future<String> getJsonData() async {
    var response = await http.post(
        ...
        Uri.encodeFull(
            'http://siplah.mascitra.co.id/siplah/api/mitra/komplain/transaksi'),
        headers: {
          "Content-Type": "application/x-www-form-urlencoded",
          "API-App": "siplah_jpmall.id",
          "Api-Key": "4P1_7Pm411_51p114h",

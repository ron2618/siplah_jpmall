          ...
          onTap: () => Navigator.push(
              ...
              PageRouteBuilder(
                  ...
                  pageBuilder: (context, _, __) =>
                       DetailProduk2(nama: widget.data[i]['produk'], gambar: widget.data[i]['foto'] != null ? widget.data[i]['foto'][0]['foto']: 'https://siplah.jpstore.id/assets/images/no-image.png',harga: widget.data[i]['harga'],))),
                        ...
                        child: Container(
                            ...
                            decoration: BoxDecoration(
                                image: DecorationImage(
                                    image: NetworkImage(
                                        widget.data[i]['foto'] != null ?widget.data[i]['foto'][0]['foto'] : 'https://siplah.jpstore.id/assets/images/no-image.png' 

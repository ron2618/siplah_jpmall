...
//                           DetailProduk2(nama: widget.data[index]['produk'], gambar: widget.data[index]['foto'] != null ? widget.data[index]['foto'][0]['foto']: 'http://192.168.1.23/siplah/assets/images/no-image.png',harga:widget.data[index]['harga']))),
//               child: Container(
//                 width: 130,
//                 height: 100,
//                 color: Colors.white,
...
//                       width: 100,
//                       child: Container(
//                         child: Image.network(widget.data[index]['foto'][0]['foto'] != null ? widget.data[index]['foto'][0]['foto']: 'http://192.168.1.23/siplah/assets/images/no-image.png', fit: BoxFit.cover,),
//                         decoration: BoxDecoration(
//                           boxShadow: <BoxShadow>[

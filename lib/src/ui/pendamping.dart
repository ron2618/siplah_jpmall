...
class Pendamping extends StatefulWidget {
  ...
  const Pendamping({Key key, this.data}) : super(key: key);
  @override
  _PendampingState createState() => _PendampingState();
}
...
//            color: Colors.brown,
        child: Column(
          ...
          children: <Widget>[
            SizedBox(height: 15,),
            Text("Pendamping K13 ", style: TextStyle(
              color: Colors.white,
              fontSize: 20,
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    SizedBox(
                      ...
                      width: 100,
                      child: Container(
                        child: Image.network("http://siplah.pesonaedu.id/uploads/afe05c0671c9b20e03b2923f784c7d21e055cafffb700ddaaf9092ee2a6035dd/1982/thumbnail.png", fit: BoxFit.cover,),
                        decoration: BoxDecoration(
                          boxShadow: <BoxShadow>[

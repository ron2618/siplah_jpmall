...
Future<http.Response> _delete(String id) async{
  //a=a+id;
  print(id);
    var url = 'https://siplah.mascitra.co.id/api/sekolah/alamat_pengiriman/delete';
  ...
  //print(id);
  print(a);
    var url = 'https://siplah.mascitra.co.id/api/sekolah/alamat_pengiriman/set_utama';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Alamat Pemesanan", style: TextStyle(color: Colors.white)),
      ),
      body: //Text("data"),
          //Text(data[0]['nama']),
          //   Row(children: <Widget>[
                              ...
                              children: <Widget>[
                                ...
                                Column(
                                  children: <Widget>[
                                    Align(
                                      alignment: Alignment.topLeft,
                                      child: Text(data[i]['kabupaten_nama']),
                                    )
                                  ],
                                ),
